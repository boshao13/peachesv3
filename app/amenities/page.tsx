...
export const metadata: Metadata = pageMeta({
  title: "Amenities",
  description:
    "Explore Peaches Fitness Club amenities — weight room, cardio, Booty Builder® equipment, group classes, sauna, cold plunge, members lounge, free Tea Bar and more in Albuquerque.",
  path: "/amenities",
});
